...
class MainMenu
{
  public void menu()
  {
    ...
    System.out.println("\n\nTo Add an Employee Details  ->   1");
    System.out.println("To See an Employee Details  ->   2 ");
    System.out.println("To Remove an Employee       ->   3");
    System.out.println("To Update Employee Details  ->   4");
    System.out.println("\n\tTo Exi::5 \t TO Contine:: enter your choice");
...
class CodeExit
{
  public void out()
  {
    ...
    System.out.println("*****************************************");
    System.out.println("CODED BY - V R N I T H I S H ");
    System.exit(0);
  }
}
...
class EmployeeManagementSystem
{
  public static void main(String arv[])
  {
	  ...
	  System.out.println("\t\t\t*********************************************************************");
	    ...
	    System.out.println("\t\t\t\t\t ----------------------------");
	    System.out.println("\t\t\t\t\t V R Software India Pvt Ltd. ");
	    System.out.println("\t\t\t\t-----------------------------------------------");
	    System.out.println("\t\t\t**********************************************************************");
